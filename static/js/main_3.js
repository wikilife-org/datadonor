...
function drawShareGraphs(data) {
    ...
    var elements1 = adapter.getParameters([data.global_data.facebook.posts,
    data.user_data.facebook.posts], maxPercentage, 100);
    ...
    var elements1 = adapter.getParameters([data.global_data.twitter.tweets,
    data.user_data.twitter.tweets], maxPercentage, 100);
...
function drawExerciseGraphs(data) {
    ...
    var maxPercentage = 100;
    var elements1 = adapter.getParameters([parseInt(data.running.global_data),
    parseInt(data.running.user_data)], maxPercentage, 100);
    ...
    dotChart.draw();
    var maxPercentage = 100;
    var elements1 = adapter.getParameters([parseInt(data.walking.global_data),
    parseInt(data.walking.user_data)], maxPercentage, 100);
    ...
    dotChart.draw();
    var maxPercentage = 100;
    var elements1 = adapter.getParameters([parseInt(data.elliptical.global_data),
    parseInt(data.elliptical.user_data)], maxPercentage, 100);
...
function drawMilesGraph(data) {
    ...
    var result = adapter.getParameters(data, 400, 60, [
        10,
        20,
        30,
        40
...
function drawHoursGraph(data) {
    var adapter = new MilesAdapter();
    var result = adapter.getParameters(data, 400, 9, [
        1,
        3,
        4,
        7
...
window.onload = function () {
    ...
    $.getJSON('../../static/js/adapter/examples/social_reach', function (data) {
        ...
        var elements1 = adapter.getParameters(data.global_data, [
            '#CDBFE0',
            '#6845C7',
            '#975EE3',
            '#CDBFE0',
        ...
        var elements2 = adapter.getParameters(data.user_data, [
            '#D44B5F',
            '#DC6666',
            '#FF836F',
            '#D44B5F',
